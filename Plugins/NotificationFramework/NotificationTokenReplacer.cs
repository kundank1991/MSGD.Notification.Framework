// <copyright file="NotificationTokenReplacer.cs" company="Microsoft">
// Copyright (c) 2016 All Rights Reserved
// </copyright>
// <author></author>
// <date>8/27/2017 12:08:08 PM</date>
// <summary>Implementation of NotificationTokenReplacer Class.</summary>
namespace MSGD.Notification.Framework.Plugins
{
    ...
    /// <summary>
    /// Notification data replacer class
    /// </summary>
    public class NotificationTokenReplacer
    {
        /// <summary>
        ...
        /// <param name="recordBaseUrl">record base URL</param>
        internal void ReplaceTemplateData(Entity primaryEntity, List<Entity> relatedEntities, Dictionary<string, dynamic> parameter, Entity notificationTemplate, string recordBaseUrl)
        {
            ...
            foreach (Entity relatedEntity in relatedEntities)
            {
                ...
                if (notificationTemplate.Contains("didd_email") && (bool)notificationTemplate.Attributes["didd_email"] == true)
                {
                    ...
                    string emailDescription = ReplacePlaceHolders(relatedEntity, primaryEntity, parameter, recordBaseUrl, this.EmailDescripiton);
                    ...
                    if (!string.IsNullOrEmpty(activitySubject))
                    {
        ...
        private static DateTime RelpcaeDueDatePlaceHolder(Entity primaryEntity, Entity relatedEntity, Dictionary<string, dynamic> parameters, DateTime? dueDate, long? duration, int? dueDateModifier, string dueDateModifierAttribute)
        {
            string entityName = string.Empty;
            string attributeName = string.Empty;
